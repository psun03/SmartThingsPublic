 ...
 *  modified 2017-05-17 :  psun03 - updated the parse function to use the new S3 storage function per Smartthings Documentation
 * 
...
metadata {
	...
	tiles (scale: 2) {
		...
		standardTile("take", "device.image", width: 6, height: 2, canChangeIcon: false, inactiveLabel: true, canChangeBackground: false) {
